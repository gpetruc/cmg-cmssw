...
parser.add_option("-s", "--signif", dest="signif", default=False, action="store_true",  help="Graph contains significances, not p-values")
...
if options.signif:
    pvals  = [ ROOT.ROOT.Math.normal_cdf_c(s, 1.0) for s in pvals ]
