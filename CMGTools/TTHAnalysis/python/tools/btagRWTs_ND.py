...
from CMGTools.TTHAnalysis.tools.BTagWeightCalculator import BTagWeightCalculator
...
class BTagReweightFriend:
    def __init__(self,reweight,jets="Jet",inlabel="btagCSV",outlabel="btagCSVWeight",rwtKind='final',rwtSyst='nominal',maxjets=20,mcOnly=True):
        self.jets = jets
        self.label = outlabel
        self.blabel = inlabel
    ...
    def __call__(self,event):
        ...
        ret[self.jets+"_"+self.label] = [ self.reweight(j) for j in jets ] 
        return ret
